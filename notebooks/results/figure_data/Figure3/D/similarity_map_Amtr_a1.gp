...
set output 'notebooks/results/figure_data/Figure3/D/Amtr_a1_similarity_map.eps'
set title 'Inter-context Similarity Scores for Amtr A1' font 'Computer Modern Roman,32'
unset key
set datafile separator comma
plot 'notebooks/results/figure_data/Figure3/D/similarity_matrix_Amtr_a1.dat' matrix rowheaders columnheaders using 1:2:3 with image
