...
set output 'notebooks/results/figure_data/Figure3/D/Lcara_i1_similarity_map.eps'
set title 'Inter-context Similarity Scores for Lcara I1' font 'Computer Modern Roman,32'
unset key
set datafile separator comma
plot 'notebooks/results/figure_data/Figure3/D/similarity_matrix_Lcara_i1.dat' matrix rowheaders columnheaders using 1:2:3 with image
