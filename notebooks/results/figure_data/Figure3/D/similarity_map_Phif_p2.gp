...
set output 'notebooks/results/figure_data/Figure3/D/Phif_p2_similarity_map.eps'
set title 'Inter-context Similarity Scores for Phif P2' font 'Computer Modern Roman,32'
unset key
set datafile separator comma
plot 'notebooks/results/figure_data/Figure3/D/similarity_matrix_Phif_p2.dat' matrix rowheaders columnheaders using 1:2:3 with image
