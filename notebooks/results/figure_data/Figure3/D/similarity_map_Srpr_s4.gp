...
set output 'notebooks/results/figure_data/Figure3/D/Srpr_s4_similarity_map.eps'
set title 'Inter-context Similarity Scores for Srpr S4' font 'Computer Modern Roman,32'
unset key
set datafile separator comma
plot 'notebooks/results/figure_data/Figure3/D/similarity_matrix_Srpr_s4.dat' matrix rowheaders columnheaders using 1:2:3 with image
