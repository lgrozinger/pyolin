...
set output 'notebooks/results/figure_data/Figure3/D/Srpr_s1_similarity_map.eps'
set title 'Inter-context Similarity Scores for Srpr S1' font 'Computer Modern Roman,32'
unset key
set datafile separator comma
plot 'notebooks/results/figure_data/Figure3/D/similarity_matrix_Srpr_s1.dat' matrix rowheaders columnheaders using 1:2:3 with image
