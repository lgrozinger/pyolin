...
set output 'notebooks/results/figure_data/Figure3/D/Bm3r1_b1_similarity_map.eps'
set title 'Inter-context Similarity Scores for Bm3r1 B1' font 'Computer Modern Roman,32'
unset key
set datafile separator comma
plot 'notebooks/results/figure_data/Figure3/D/similarity_matrix_Bm3r1_b1.dat' matrix rowheaders columnheaders using 1:2:3 with image
